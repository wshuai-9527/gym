export class StorageManager{
  ...
  migrate(old){const next={...this.clone(this.defaultState),...old,version:this.defaultState.version};next.records=Array.isArray(next.records)?next.records:[];next.checkins=next.checkins||{};next.timers=next.timers||{};next.defaultMergedVersion=old.defaultMergedVersion||'';return next}
